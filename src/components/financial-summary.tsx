...
export async function FinancialSummary({page}:{page:number}){
 ...
 return <main className="content finance-content">
  ...
  <p className="mt-5 text-xs text-zinc-500">Os valores refletem os registros do sistema, sem consulta ao banco. Baixas parciais entram pelo valor efetivamente pago ou recebido. Contas excluídas deixam de aparecer no resumo.</p>
