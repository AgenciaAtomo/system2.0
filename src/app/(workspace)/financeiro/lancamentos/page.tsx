  ...
  <div className="grid gap-6 2xl:grid-cols-[minmax(0,1fr)_360px]">
   <section className="min-w-0 rounded-xl border border-zinc-200 bg-white p-5 sm:p-6">
    ...
    <form className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-3">
     ...
     <label className="text-xs font-medium">Conta<select name="account_id" defaultValue={filters.account_id} className={input}><option value="">Todas as contas</option>{activeAccounts.map(a=><option key={a.id} value={a.id}>{a.name}</option>)}</select></label>
